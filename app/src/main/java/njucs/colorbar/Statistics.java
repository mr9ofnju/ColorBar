...
public class Statistics {
    ...
    public void doStat(){
        ...
        int bitsPerFrame=matrix.contentWidth*matrix.contentHeight*matrix.bitsPerBlock;
        ...
        Log.d(TAG,"matrix: contentWidth: "+matrix.contentWidth+"matrix: contentHeight: "+matrix.contentHeight+" ecLength: "+matrix.ecLength+" ecNum: "+matrix.ecNum);
    }
